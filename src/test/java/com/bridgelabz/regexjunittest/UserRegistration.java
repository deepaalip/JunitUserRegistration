...
import com.bridgelabz.regexjunittest.FirstNameException.ExceptionType;
import com.bridgelabz.regexjunittest.LastNameException.ExceptionType1;
import com.bridgelabz.regexjunittest.EmailException.ExceptionType2;
import com.bridgelabz.regexjunittest.PhoneNumberException.ExceptionType3;
import com.bridgelabz.regexjunittest.PasswordException.ExceptionType4;
...
public class UserRegistration {
		...
		public boolean validateFirstName(String firstName) throws FirstNameException {
			...
			if(firstName.length() == 0) {
				throw new FirstNameException(ExceptionType.EmptyString, "Enter Proper Message. EMPTY Not Allowed");

			}
			}
			catch (NullPointerException e) {
				throw new FirstNameException(ExceptionType.Null, "Enter Proper Message. NULL Not Allowed");
			}
		...
		public boolean validateLastName(String lastName)throws LastNameException{
			...
			if(lastName.length() == 0) {
				throw new LastNameException(ExceptionType1.EmptyString, "Enter Proper Message. EMPTY Not Allowed");

			}
			}
			catch (NullPointerException e) {
				throw new LastNameException(ExceptionType1.Null, "Enter Proper Message. NULL Not Allowed");
			}
		...
		public boolean validateEmail(String mail) throws EmailException {
			...
			if(mail.length() == 0) {
				throw new EmailException(ExceptionType2.EmptyString, "Enter Proper Message. EMPTY Not Allowed");
			}
			}
			catch (NullPointerException e) {
				throw new EmailException(ExceptionType2.Null, "Enter Proper Message. NULL Not Allowed");
			}
			return isMailValid;
		}
		public boolean validatePhoneNumber(String number) throws PhoneNumberException {
			...
			if(number.length() == 0) {
				throw new PhoneNumberException(ExceptionType3.EmptyString, "Enter Proper Message. EMPTY Not Allowed");
			}
			}
			catch (NullPointerException e) {
				throw new PhoneNumberException(ExceptionType3.Null, "Enter Proper Message. NULL Not Allowed");
			}
		...
		public boolean validatePassword(String password) throws PasswordException {
			...
			if(password.length() == 0) {
				throw new PasswordException(ExceptionType4.EmptyString, "Enter Proper Message. EMPTY Not Allowed");
			}
			}
			catch (NullPointerException e) {
				throw new PasswordException(ExceptionType4.Null, "Enter Proper Message. NULL Not Allowed");
			}
